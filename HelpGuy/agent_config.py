...
Here are some articles related to a medicinal issue. 
...
The format should be as follows, fill in the information where it says and remove the quotations. 
Do not add any extra numbering or punctuation. Keep summary to one paragraph. Do not add any title or subsections
